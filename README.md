...
|---|---:|---|
| Empty cache: `index --semantic` | 10m 02.0s | 7.11 GB validated reusable cache; 2.98 GiB maximum RSS and zero swaps under the 3 GiB scheduling profile |
| Empty analysis cache: complete production taint analysis | 32.0s | Requested analysis completed without requiring the whole semantic prewarm |
...
| After index: search | 4.4s | Exact requested matches |
...
| After index: complete production taint analysis | 11.0s | Requested fixed point completed without a semantic cap |
