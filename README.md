...
| Empty analysis cache: complete production taint analysis | 33.1s | Requested analysis completed without requiring the whole semantic prewarm |
...
| After index: complete production taint analysis | 11.3s | Requested fixed point completed without a semantic cap |
