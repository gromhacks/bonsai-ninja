...
the bases facts. It also binds local callable aliases and uniquely
returned closure factories so indirect callback calls stay resolver-backed
instead of becoming name-only fan-out.
