...
- `cargo test --workspace --no-fail-fast -- --test-threads=1` is green as of 2026-06-04, including doc tests and the 21-language CLI, inspect, adapter, taint, cache, SARIF, and mega-flow suites.
