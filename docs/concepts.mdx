...
Each of the 21 adapters owns its grammar and converts language syntax into
...
source analysis, dump-taint, compatibility APIs, and native export. Bounded
path enumeration exists only for requested previews and diagnostics; those
surfaces report truncation and never alter reachability.
