...
pub use kit::{
    ...
    apply_module_path_semantic_identity, assignment_trace_message, c_family_preproc_imports,
    collect_assign_targets, collect_constructor_result_type_aliases, collect_modifier_visibility,
    collect_param_type_aliases, collect_return_spans, decl_index_from_tree_with_handler,
    ...
    extract_imports_via, extract_runtime_type_narrowing_facts, for_each_flow_event, inject_lifecycle_events,
    ...
    rewrite_implicit_member_reads, tuple_result_projection_index, AliasTarget, GrammarHandler,
    ImplicitMemberReadCall, LifecycleTransition, ModifierVocabulary, SyntaxSpecialForm, TypeAliasVocabulary,
    EMPTY_HANDLER, MODULE_DECL_NAME, WILDCARD_IMPORT_ALIAS_PREFIX,
};
...
pub use types::{
    ...
    CompilerGuardFact, CompilerSyntaxHeader, CompilerWriteAttribution, ConditionEquality,
    ConditionExpressionFact, ConditionOperandFact, Decl, DeclIndex, DeclKind, DynamicKeyFilterFact,
    ExpressionField, ExpressionFlow, ExpressionProjection, FieldWrite, FiniteLiteralSelectionFact, FlowEvent,
    GuardedValueFilterFact, ImportIndex, ImportScope, ImportSpec, LanguageId, LoopKind,
