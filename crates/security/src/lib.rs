...
pub use analysis::{
    ...
    sanitizer_inventory, security_match_rows, seed_idg_service_for_rulepack, select_pack_rules, select_rules,
    sink_inventory, source_inventory, source_rule_matches_filters, taint_transfers_from_rulepack,
    ...
    RulepackTaintTransfers, SecurityInventoryOptions, SecurityMatchRow, SourceAnalysisCandidate,
    SourceAnalysisOptions, SourceAnalysisReport, SourceLineageLimits, SourceLineageStatus,
    SourceLineageSummary, TaintAnalysisOptions, TaintAnalysisReport, CANONICAL_SINK_FAMILIES,
    ECOSYSTEM_SPECIFIC_SINK_AUDIT_LANGS, FAMILY_NOT_APPLICABLE,
};
...
pub use rule::{
    ArgTaintedSpec, ConstraintKind, MatchKind, MatchSpec, MustAliasSpec, PayloadType, RequiresStateSpec,
    Rule, RuleConstraint, RuleKind, RuleTarget, RuntimeTypeSpec, Severity, TrustClass,
};
