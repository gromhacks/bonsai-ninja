...
///
/// Bump this when `bonsai_security::matcher` changes `LaxTail`,
/// `OnlyWhenPackaged`, import/package gating, or method-chain fallback
/// semantics in a way that can change matched rule sites. Also bump
