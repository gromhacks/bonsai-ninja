    ...
    run_positive_cell(
        ...
        LangFixture {
            ...
            files: &[
                ...
                ("entry.js", "export async function entry(args) { const util = await import('./util.js'); util.helper(args); }\n"),
            ],
            entry: "entry",
            seed: &["args"],
            sink: "sink",
    ...
    run_positive_cell(
        ...
        LangFixture {
            ...
            files: &[
                ...
                ("entry.ts", "export async function entry(args: string) { const util = await import('./util'); util.helper(args); }\n"),
            ],
            entry: "entry",
            seed: &["args"],
            sink: "sink",
