...
pub use reachable::{
    ...
    entry_taint_call_records_from_idg_with_max_precision, entry_taint_graph_from_idg,
    entry_taint_graph_from_idg_with_max_precision, merge_into, name_reachable_through_chain_kinded,
