...
from domain.transformers import batch_expand, normalize
from domain.validators import validate_payload
...
async def orchestrate(envelope: dict[str, Any]) -> tuple[bool, Any]:
    ...
    try:
        ...
        async for chunk in stream_batch(envelope):
            ...
            from infrastructure.storage import AuditedRepository
