...
defmodule App do
  # Exact compiler-owned controller role used by the Phoenix parameter-source
  # rule. A mere module alias does not establish that arbitrary two-argument
  # functions are remotely reachable controller actions.
  use Web, :controller
