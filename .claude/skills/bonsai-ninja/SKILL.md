...
compatibility: "Project-level shim for the canonical .agents skill."
---

# Bonsai Ninja

The canonical cross-agent skill for this repository is:

```text
../../../.agents/skills/bonsai-ninja/SKILL.md
```

Read that file and follow it. Load its referenced files only when the
task needs the extra command matrix or detailed workflows:

- `../../../.agents/skills/bonsai-ninja/references/command-reference.md`
- `../../../.agents/skills/bonsai-ninja/references/workflows.md`
